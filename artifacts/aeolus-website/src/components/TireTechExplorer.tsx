...
const SAMPLE_POINTS: Point[] = [
  {
    ...
    bullets: ["Reduced road noise", "Increased adherence to reduce hydroplaning"],
    x: 20,
    y: 10,
  },
  {
  ...
  },
  {
    ...
    bullets: [
      "Better contact patch provides more even wear, extending tread life",
      "Improved belt integrity",
    ],
    x: 55,
    y: -5,
  },
  {
    ...
    bullets: ["Reduces rolling resistance", "Even tread wear increases mileage"],
    x: 30,
    y: -4,
  },
  {
    id: 5,
    title: "3D - Sipe",
    bullets: ["Enhanced traction", "Improves safety and handling by interlocking under pressure"],
    x: 33,
    y: 17,
  },
  {
  ...
  },
  {
    ...
    bullets: [
      "Enhanced even wear",
      "Improved handling",
      "Extended tire life and retreadability",
    ],
    x: 69,
    y: 22,
  },
