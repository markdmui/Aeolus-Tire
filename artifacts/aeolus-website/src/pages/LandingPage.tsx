  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", overflow: "hidden", backgroundColor: "#0a0a0a" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('/index-1.jpg')", backgroundSize: "120%", backgroundPosition: "left center", backgroundRepeat: "no-repeat" }} />
            ...
            <AnimatePresence mode="wait" custom={iconDir}>
              {!iconHovered ? (
                ...
                <motion.span
                  ...
                  exit="exit"
                  transition={{ duration: 0.18, ease: "easeOut" }}
                  style={{ position: "absolute", display: "flex", color: "#ffffff" }}
                >
                  <ArrowSquareRight size={20} />
                </motion.span>
              )}
