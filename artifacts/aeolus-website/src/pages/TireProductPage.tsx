      ...
      >
        ...
        <div className="tire-hero-text md:pb-8">
          ...
          <motion.div
            ...
            transition={{ duration: 0.42, delay: 0.1, ease: [0.55, 0.055, 0.675, 0.19] }}
            style={{
          ...
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.48, delay: 0.2, ease: [0.55, 0.055, 0.675, 0.19] }}
            style={{
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.45, delay: 0.35, ease: [0.55, 0.055, 0.675, 0.19] }}
            style={{
          ...
          <motion.div
            ...
            animate={{ scaleX: 1 }}
            transition={{ duration: 0.36, delay: 0.5, ease: [0.55, 0.055, 0.675, 0.19] }}
          ...
          <motion.img
            ...
            transition={{ duration: 0.48, delay: 1.0, ease: [0.55, 0.055, 0.675, 0.19] }}
        ...
        <motion.div
          ...
          transition={{ duration: 0.54, delay: 0.1, ease: [0.55, 0.055, 0.675, 0.19] }}
        >
          <div
            ...
            {[
              ...
              return href ? (
                <motion.a key={label} href={href}
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.39, delay: i * 0.15, ease: [0.55, 0.055, 0.675, 0.19] }}
